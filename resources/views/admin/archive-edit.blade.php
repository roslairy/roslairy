...
@section('content')
<div class="row">
    <form class="blog-archive-block" method="post" action="{{ route('archive-save') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input name="picture" type="file" class="" id="picture" placeholder="图片">
        </div>
        <div class="form-group">
